...
function hua(){
	$(".listProduct").children(".product").children("a").hover(
		function(){
			$(this).children(".list_pop").css({"display":"block"})
		},
		function(){
			$(this).children(".list_pop").css({"display":"none"})
		}
	)
	$(".list_top").children(".p01").children(".chima").hover(
		function(){
			$(this).children(".abc").css({"display":"block"});
			$(this).children(".biaozhun").css({"display":"block"})
		},
		function(){
			$(this).children(".abc").css({"display":"none"});
			$(this).children(".biaozhun").css({"display":"none"})
		}
	);
	
	
//	$(".product").children("a").hover(
//			function(){
//				$(".product").children(".duct").css({
//					"display":"none"
//				})
//			},
//			function(){
